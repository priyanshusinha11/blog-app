    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        <div className="max-w-lg text-center">
          <h1 className="text-4xl font-bold mb-4">Welcome to Blog-It</h1>
          <p className="text-lg text-gray-700 mb-2">
            Explore a variety of articles on different topics written by our talented authors, and feel free to pen down your thoughts as you dive into their insights.
          </p>
          <p className="text-red-500 mb-1">LogIn/SignUp to read and write blogs</p>
